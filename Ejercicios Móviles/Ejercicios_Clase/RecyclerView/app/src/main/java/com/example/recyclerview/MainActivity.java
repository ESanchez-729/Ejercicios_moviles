...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 40; i++) {
            datos.add(new Encapsulador(R.drawable.beluga, getString(R.string.titulo1), getString(R.string.description)));
            datos.add(new Encapsulador(R.drawable.pinguino, getString(R.string.titulo2), getString(R.string.description2)));
        }
        ...
        reciclador.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e) {
                ...
                if (hijo != null && gestureDetector.onTouchEvent(e)) {
                    ...
                    Toast.makeText(getApplicationContext(), datos.get(position).getTitulo(), Toast.LENGTH_LONG).show();
                }
                return false;
            }
